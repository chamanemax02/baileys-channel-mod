...
export declare const makeNewsletterSocket: (config: SocketConfig) => {
    ...
    newsletterSendMessage: (jid: string, content: import("../index.js").AnyMessageContent, options?: import("../index.js").MiscMessageGenerationOptions) => Promise<import("../index.js").proto.WebMessageInfo | undefined>;
    sendInteractiveMessage: (jid: string, data: any, options?: import("../index.js").MiscMessageGenerationOptions) => Promise<import("../index.js").proto.WebMessageInfo | undefined>;
    sendInteractiveButtons: (jid: string, data: any, options?: import("../index.js").MiscMessageGenerationOptions) => Promise<import("../index.js").proto.WebMessageInfo | undefined>;
