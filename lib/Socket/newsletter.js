...
export const makeNewsletterSocket = (config) => {
    ...
    return {
        ...
        newsletterSendMessage: async (jid, content, options) => {
            ...
            return sock.sendMessage(channelJid, content, options);
        },
        sendInteractiveMessage: async (jid, data, options = {}) => {
            return sock.sendMessage(jid, { interactive: data }, options);
        },
        sendInteractiveButtons: async (jid, data, options = {}) => {
            return sock.sendMessage(jid, { buttons: data.buttons, ...data }, options);
        }
    };
};
